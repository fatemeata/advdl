...
def run(args):
    ...
    # TODO: adjust folder
    dataset = datasets.CIFAR10('cifar-10-batches-py', download=True, train=True, transform=transform)
    ...
    # TODO: adjust folder
    testset = datasets.CIFAR10('cifar-10-batches-py', download=True, train=False, transform=transform)
    ...
    if args.model == "r18":
        ...
        model = ViT(image_size = 32, patch_size = 16, num_classes = 10, dim = 64,
    ...
    acc = test(model, device, testloader, criterion)
    if args.save_model:
